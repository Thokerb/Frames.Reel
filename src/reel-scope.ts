...
import {  isStringExpression, isVariableOverride, State } from './language/generated/ast.js';
...
export class ReelScopeProvider extends DefaultScopeProvider {
    override getScope(context: ReferenceInfo): Scope {
        ...
        if (context.property === 'ref' && isVariableOverride(context.container)) {
            ...
            console.log(isStringExpression(context.container));
    ...
    private scopeClassMembers(classItem: Reference<State>): Scope {
        ...
        console.log('ReelScopeProvider.scopeClassMembers2', classItem);
